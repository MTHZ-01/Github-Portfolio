  ...
  return (
    <section id="projects" className="py-24">
      <div className="max-w-6xl mx-auto px-6">
            ...
            {repos.length > 0 ? (
              repos.map(repo => (
                <a 
                  ...
                  className="bg-gray-700/6 p-6 rounded-2xl border border-gray-600/15 hover:border-gray-500/25 shadow-[inset_0_1px_1px_rgba(150,150,150,0.04)] hover:shadow-[inset_0_1px_1px_rgba(150,150,150,0.08),0_8px_16px_rgba(100,100,100,0.02)] transition group"
                >
        ...
        <div className="mt-12 bg-gray-700/4 p-6 rounded-2xl border border-gray-600/15 shadow-[inset_0_1px_1px_rgba(150,150,150,0.04),0_12px_30px_rgba(100,100,100,0.01)]">
          <h3 className="text-2xl font-semibold mb-4">{translations[language].featuredProduct}</h3>
          <div className="flex flex-col md:flex-row gap-6 items-start">
            <div className="w-full md:w-1/2 rounded-xl overflow-hidden border border-gray-600/15 shadow-[inset_0_1px_1px_rgba(150,150,150,0.04)]">
              <img src={softwareImg} alt="Developed software" className="w-full h-60 object-cover block" />
            </div>

            <div className="w-full md:w-1/2">
              <p className="text-gray-200 mb-4">This is the software I developed — click to view repository or details above.</p>
